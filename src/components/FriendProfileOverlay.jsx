  ...
  render() {
    ...
    return (
      <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/80 backdrop-blur-md" onClick={onClose}>
        <div className="w-full max-w-lg rounded-2xl border border-white/[0.08] bg-[#111114] shadow-[0_24px_80px_rgba(0,0,0,0.6)] overflow-hidden" onClick={(e) => e.stopPropagation()}>
          {loading ? (
    ...
    return (
      <div>
        ...
        <div className="px-6 py-4">
          ...
          {/* Collection + Rank details */}
          <div className="grid grid-cols-2 gap-2 mb-4">
            <div className="rounded-xl bg-white/[0.03] border border-white/[0.06] p-3">
              <div className="text-[10px] font-semibold uppercase tracking-widest text-white/25 mb-1.5">Collection</div>
              <div className="text-sm text-white/80 font-medium">{profile.uniqueCards || 0} <span className="text-white/30 font-normal">unique</span></div>
              <div className="text-xs text-white/30">{profile.collectionSize || 0} total cards</div>
            </div>
            <div className="rounded-xl bg-white/[0.03] border border-white/[0.06] p-3">
